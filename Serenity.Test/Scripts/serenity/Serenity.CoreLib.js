...
(function (Q) {
    ...
    Q.stripDiacritics = stripDiacritics;
    ...
    function turkishLocaleCompare(a, b) {
        ...
        for (var i_1 = 0, _len = Math.min(a.length, b.length); i_1 < _len; i_1++) {
            var x = a.charAt(i_1), y = b.charAt(i_1);
            if (x === y)
                continue;
            ...
            new Serenity.QuickSearchInput(this.byId("Search"), {
                onSearch: function (fld, txt, done) {
                    ...
                    _this.element.find('li').each(function (x, e) {
                        $(e).toggle(!txt || Q.stripDiacritics($(e).text().toLowerCase()).indexOf(txt) >= 0);
                    });
                }
            });
