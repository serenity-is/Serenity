...
function makeModalMaximizable(dialog: Dialog) {
    ...
    const maximizeButton = <button type="button" class="btn btn-window-maximize" style={{
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-window-fullscreen maximize-image" viewBox="0 0 16 16">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-window-stack restore-image" viewBox="0 0 16 16">
