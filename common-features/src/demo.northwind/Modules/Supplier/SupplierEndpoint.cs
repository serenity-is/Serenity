...
public class SupplierEndpoint : ServiceEndpoint
{
    ...
    public Task<SaveResponse> Create(IUnitOfWork uow, SaveRequest<MyRow> request,
        [FromServices] ISupplierSaveHandler handler, CancellationToken cancellationToken = default)
    {
    ...
    public Task<DeleteResponse> Delete(IUnitOfWork uow, DeleteRequest request,
        [FromServices] ISupplierDeleteHandler handler, CancellationToken cancellationToken = default)
    {
    ...
    public Task<RetrieveResponse<MyRow>> Retrieve(IDbConnection connection, RetrieveRequest request,
        [FromServices] ISupplierRetrieveHandler handler, CancellationToken cancellationToken = default)
    {
    ...
    public Task<ListResponse<MyRow>> List(IDbConnection connection, ListRequest request,
        [FromServices] ISupplierListHandler handler, CancellationToken cancellationToken = default)
    {
