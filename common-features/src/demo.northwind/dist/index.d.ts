...
export declare class NotesEditor<P = {}> extends EditorWidget<P> implements IGetEditValue, ISetEditValue {
	static typeInfo: import("@serenity-is/corelib").EditorTypeInfo<"Serenity.Demo.Northwind.">;
...
export declare class OrderDetailDialog extends GridEditorDialog<OrderDetailRow> {
	static typeInfo: import("@serenity-is/corelib").ClassTypeInfo<"Serenity.Demo.Northwind.">;
...
export declare class EmployeeListFormatter implements Formatter {
	static typeInfo: import("@serenity-is/corelib").FormatterTypeInfo<"Serenity.Demo.Northwind.">;
