...
INSERT INTO "Products" VALUES (5, 'Chef Anton''s Gumbo Mix', 2, 2, '36 boxes', 21.3500004, 0, 0, 0, false);
...
SELECT setval('categories_seq', max("CategoryID")) FROM "Categories";
SELECT setval('employees_seq', max("EmployeeID")) FROM "Employees";
SELECT setval('orders_seq', max("OrderID")) FROM "Orders";
SELECT setval('products_seq', max("ProductID")) FROM "Products";
SELECT setval('region_seq', max("RegionID")) FROM "Region";
SELECT setval('shippers_seq', max("ShipperID")) FROM "Shippers";
SELECT setval('suppliers_seq', max("SupplierID")) FROM "Suppliers";
SELECT setval('usstates_seq', max("StateID")) FROM "UsStates";