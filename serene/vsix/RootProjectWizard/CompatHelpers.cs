...
{ 
    ...
    {
        public static bool Contains(this string text, string str, StringComparison comparison)
        {
            return text.IndexOf(str, comparison) >= 0;
        }
        
        public static bool StartsWith(this string text, char c)
        {
            return text.Length > 0 && text[0] == c;
        }
    }
}