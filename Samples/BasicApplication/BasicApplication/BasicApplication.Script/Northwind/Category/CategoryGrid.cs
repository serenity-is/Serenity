...
namespace BasicApplication.Northwind
{
    ...
    public class CategoryGrid : EntityGrid<CategoryRow>
    {
        ...
        protected override List<SlickColumn> GetColumns()
        {
            ...
            columns.Add(new SlickColumn { Field = "CategoryName", Width = 200, Format = ItemLink() });
            columns.Add(new SlickColumn { Field = "Description", Width = 80 });
            columns.Add(new SlickColumn { Field = "Picture", Width = 80 });
