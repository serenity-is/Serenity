...
namespace Serenity.Net.CodeGenerator.TerminalGui
{
    internal class Program
    {
        ...
        {
            var exitCode = new App(new FileSystem(), () => new Serenity.CodeGenerator.MSBuild.MSBuildProjectSystem()).Run(args);
    ...
    public class App
    {
        ...
        public Func<IBuildProjectSystem> ProjectSystemFactory { get; }

        public App(IFileSystem fileSystem, Func<IBuildProjectSystem> projectSystemFactory)
        {
            FileSystem = fileSystem ?? throw new System.ArgumentNullException(nameof(fileSystem));
            ProjectSystemFactory = projectSystemFactory ?? throw new ArgumentNullException(nameof(projectSystemFactory));
        }
