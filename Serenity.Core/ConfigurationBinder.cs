...
// taken from https://github.com/aspnet/Configuration/blob/dev/src/Microsoft.Extensions.Configuration.Binder/ConfigurationBinder.cs
namespace Microsoft.Extensions.Configuration
{
    ...
    public static class ConfigurationBinder
    {
        ...
        class Resources
        {
            public static string FormatError_CannotActivateAbstractOrInterface(Type type)
            {
                throw new NotImplementedException();
            }

            public static string FormatError_UnsupportedMultidimensionalArray(Type type)
            {
                throw new NotImplementedException();
            }

            public static string FormatError_MissingParameterlessConstructor(Type type)
            {
                throw new NotImplementedException();
            }

            public static string FormatError_FailedToActivate(Type type)
            {
                throw new NotImplementedException();
            }

            public static string FormatError_FailedBinding(string value, Type type)
            {
                throw new NotImplementedException();
            }
        }
