...
namespace Serenity.Reflection
{
    ...
    public static class AnnotationTypeExtensions
    {
        ...
        /// </summary>
        /// <param name="registry">Annotation registry</param>
        /// <param name="type">The type.</param>
        /// <returns>
        /// Annotated type information
        /// </returns>
        public static IAnnotatedType GetAnnotatedType(this IAnnotationTypeRegistry registry, Type type)
        {
            return new AnnotatedType(registry.GetAnnotationTypesFor(type));
        }
