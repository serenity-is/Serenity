...
this._serializedEditorValue=this._currentEditor.serializeValue();if(this._currentEditor.position){this.handleActiveCellPositionChange()}}commitEditAndSetFocus(){if(this.getEditorLock().commitCurrentEdit()){this.setFocus();if(this._options.autoEdit){this.navigateDown()}}}cancelEditAndSetFocus(){if(this.getEditorLock().cancelCurrentEdit()){this.setFocus()}}getActiveCellPosition(){return x(this._activeCellNode)}getGridPosition(){return x(this._container)}getCellEditor(){return this._currentEditor}getActiveCell(){if(!this._activeCellNode){return null}else{return{row:this._activeRow,cell:this._activeCell}}}getActiveCellNode(){return this._activeCellNode}scrollActiveCellIntoView(){if(this._activeRow!=null&&this._activeCell!=null){this.scrollCellIntoView(this._activeRow,this._activeCell)}}scrollRowIntoView(t,e){if(!this._layout.isFrozenRow(t)){var i=Math.round(b(getComputedStyle(this._layout.getScrollContainerY()).height))
