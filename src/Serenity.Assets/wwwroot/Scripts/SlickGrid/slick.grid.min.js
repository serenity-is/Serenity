...
updateCellCssStylesOnRenderedRows(t,e){var i,s,o,l;for(var r in this._rowsCache){l=e&&e[r];o=t&&t[r];if(l){for(s in l){if(!o||l[s]!=o[s]){i=this.getCellNode(parseInt(r,10),this.getColumnIndex(s));if(i){const t=l[s];b(i,t)}}}}if(o){for(s in o){if(!l||l[s]!=o[s]){i=this.getCellNode(parseInt(r,10),this.getColumnIndex(s));if(i){const t=o[s];a(i,t)}}}}}}addCellCssStyles(t,e){if(this._cellCssClasses[t]){throw"addCellCssStyles: cell CSS hash with key '"+t+"' already exists."}this._cellCssClasses[t]=e;this.updateCellCssStylesOnRenderedRows(e,null);this.trigger(this.onCellCssStylesChanged,{key:t,hash:e})}removeCellCssStyles(t){if(!this._cellCssClasses[t]){return}this.updateCellCssStylesOnRenderedRows(null,this._cellCssClasses[t]);delete this._cellCssClasses[t];this.trigger(this.onCellCssStylesChanged,{key:t,hash:null})}setCellCssStyles(t,e){var i=this._cellCssClasses[t];this._cellCssClasses[t]=e;this.updateCellCssStylesOnRenderedRows(e,i);this.trigger(this.onCellCssStylesChanged,{key:t,hash:e})
...
;var e=t.isImmediatePropagationStopped&&t.isImmediatePropagationStopped();if(!e){if(!t.shiftKey&&!t.altKey){if(this._options.editable&&this._currentEditor&&this._currentEditor.keyCaptureList){if(this._currentEditor.keyCaptureList.indexOf(t.which)>=0){return}}if(t.which==m.HOME){if(t.ctrlKey){this.navigateTop();e=true}else e=this.navigateRowStart()}else if(t.which==m.END){if(t.ctrlKey){this.navigateBottom();e=true}else e=this.navigateRowEnd()}}}if(!e){if(!t.shiftKey&&!t.altKey&&!t.ctrlKey){if(this._options.editable&&this._currentEditor&&this._currentEditor.keyCaptureList){if(this._currentEditor.keyCaptureList.indexOf(t.which)>=0){return}}if(t.which==m.ESCAPE){if(!this.getEditorLock().isActive()){return}this.cancelEditAndSetFocus()}else if(t.which==m.PAGEDOWN){this.navigatePageDown();e=true}else if(t.which==m.PAGEUP){this.navigatePageUp();e=true}else if(t.which==m.LEFT){e=this.navigateLeft()}else if(t.which==m.RIGHT){e=this.navigateRight()}else if(t.which==m.UP){e=this.navigateUp()
}else if(t.which==m.DOWN){e=this.navigateDown()}else if(t.which==m.TAB){if(this._options.enableTabKeyNavigation)e=this.navigateNext()}else if(t.which==m.ENTER){if(this._options.editable){if(this._currentEditor){if(this._activeRow===this.getDataLength()){this.navigateDown()}else{this.commitEditAndSetFocus()}}else{if(this.getEditorLock().commitCurrentEdit()){this.makeActiveCellEditable()}}}e=true}}else if(t.which==m.TAB&&t.shiftKey&&!t.ctrlKey&&!t.altKey){e=this.navigatePrev()}}if(e){t.stopPropagation();t.preventDefault();try{t.originalEvent.keyCode=0}catch(t){}}}handleClick(t){if(!this._currentEditor){if(t.target!=document.activeElement||this._jQuery(t.target).hasClass("slick-cell")){this.setFocus()}}var e=this.getCellFromEvent(t);if(!e||this._currentEditor!=null&&this._activeRow==e.row&&this._activeCell==e.cell){return}this.trigger(this.onClick,{row:e.row,cell:e.cell},t);if(t.isImmediatePropagationStopped&&t.isImmediatePropagationStopped()){return}
if(this.canCellBeActive(e.row,e.cell)){if(!this.getEditorLock().isActive()||this.getEditorLock().commitCurrentEdit()){var i=t.target&&t.target.classList.contains(R);var s=this._cols[e.cell];var o=!!(this._options.editable&&s&&s.editor&&this._options.suppressActiveCellChangeOnEdit);this.setActiveCellInternal(this.getCellNode(e.row,e.cell),null,i,o,t)}}}handleContextMenu(t){var e=t.target.closest(".slick-cell");if(!e){return}if(this._activeCellNode===e&&this._currentEditor!=null){return}this.trigger(this.onContextMenu,{},t)}handleDblClick(t){var e=this.getCellFromEvent(t);if(!e||this._currentEditor!=null&&this._activeRow==e.row&&this._activeCell==e.cell){return}this.trigger(this.onDblClick,{row:e.row,cell:e.cell},t);if(t.isImmediatePropagationStopped&&t.isImmediatePropagationStopped()){return}if(this._options.editable){this.gotoCell(e.row,e.cell,true)}}handleHeaderMouseEnter(t){const e=this.getColumnFromNode(t.target);e&&this.trigger(this.onHeaderMouseEnter,{column:e},t)}
