...
{ "@", SyntaxKind.AtToken },
        ...
        public U ForEachLeadingCommentRange<T, U>(string text, int pos, Func<(int pos, int end, SyntaxKind kind, bool hasTrailingNewLine, T state, U memo), U> cb, T state)
        {
            return IterateCommentRanges(/*reduce*/ false, text, pos, /*trailing*/ false, cb, state);
        }


        public U ForEachTrailingCommentRange<T, U>(string text, int pos, Func<(int pos, int end, SyntaxKind kind, bool hasTrailingNewLine, T state, U memo), U> cb, T state)
        {
        ...
        public bool IsIdentifierText(string name)
        {
