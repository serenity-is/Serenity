...
namespace Serenity.Data
{
    public class BasicFilterStringConverter
    {
        ...
        private IFilterFields filterFields;
        ...
        public BasicFilterStringConverter(IGetExpressionByName query, 
            ...
            IFilterFields filterFields = null)
        {
            _query = query;
            _row = row;
            ...
            if (filterFields == null && row != null)
                filterFields = row.GetFields().FilterFields;
        }
        ...
        private long ParseIntegerValue(Field field, string valueText)
        {
            ...
            {
                var enumType = field is IEnumTypeField ? ((IEnumTypeField)field).EnumType : null;
