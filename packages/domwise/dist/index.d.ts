 ...
 */
export type JSXElement = HTMLElement | (ConfigureJSXElement["svg"] extends false ? never : SVGElement) | (ConfigureJSXElement["mathml"] extends false ? never : MathMLElement);
