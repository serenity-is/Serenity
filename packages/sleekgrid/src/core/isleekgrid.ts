...
export interface ISleekGrid<TItem = any> extends CellNavigation, EditorHost, GridPluginHost {
    ...
    readonly onDrag: EventEmitter<ArgsGrid, UIEvent & { dragData: DragData }>;
    readonly onDragEnd: EventEmitter<ArgsGrid, UIEvent & { dragData: DragData }>;
    readonly onDragInit: EventEmitter<ArgsGrid, UIEvent & { dragData: DragData }>;
