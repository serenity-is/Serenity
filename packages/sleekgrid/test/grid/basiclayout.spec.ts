...
function isHidden(element: HTMLElement | null): boolean {
    return !element || element.classList.contains("slick-hidden") || element.style.display === "none";
}

function isVisible(element: HTMLElement | null): boolean {
    return element != null && !element.classList.contains("slick-hidden") && element.style.display !== "none";
}
