/** @internal */
export const isAssignableFromSymbol: unique symbol = Symbol.for("Serenity.isAssignableFromHook");
/** @internal */
export const isInstanceOfTypeSymbol: unique symbol = Symbol.for("Serenity.isInstanceOfTypeHook");
/** @internal */
...
/** @internal */
export const scriptDataItemSymbol: unique symbol = Symbol.for("Serenity.scriptDataItem");
/** @internal */
...
/** @internal */
export const typeRegistrySymbol: unique symbol = Symbol.for("Serenity.typeRegistrySymbol");
