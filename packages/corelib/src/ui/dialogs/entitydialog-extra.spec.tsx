...
import { PropertyItemsData, Authorization, serviceCall, Fluent, localText } from "../../base";
...
describe("EntityDialog.doDelete", () => {
    it("calls deleteHandler and triggers ondatachange", () => {
        ...
        (dialog as any).doDelete(callback);
...
describe("EntityDialog.undelete", () => {
    it("calls undeleteHandler and triggers ondatachange", () => {
        ...
        (dialog as any).undelete(callback);
...
describe("EntityDialog.additionalMethods", () => {
    it("getUndeleteOptions returns empty object", () => {
        class D extends EntityDialog<any, any> {
            getPropertyItemsData() { return mockPropertyItemsData(); }
        }
        const d = new D({});
        expect((d as any).getUndeleteOptions()).toEqual({});
        d.destroy();
    });
    ...
    it("getDeleteOptions returns empty object", () => {
        class D extends EntityDialog<any, any> {
            getPropertyItemsData() { return mockPropertyItemsData(); }
        }
        const d = new D({});
        expect((d as any).getDeleteOptions(vi.fn())).toEqual({});
        d.destroy();
    });
