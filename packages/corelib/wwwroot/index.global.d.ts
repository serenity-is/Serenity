...
declare namespace Serenity {
    ...
    */
     ...
     */
    function alertDialog(message: string, options?: MessageDialogOptions): Partial<ICommonDialog>;
     ...
     * }
     */
    function confirmDialog(message: string, onYes: () => void, options?: ConfirmDialogOptions): Partial<ICommonDialog>;
    /**
     ...
     * }
     */
    function informationDialog(message: string, onOk?: () => void, options?: MessageDialogOptions): Partial<ICommonDialog>;
    /**
     ...
     * }
     */
    function successDialog(message: string, onOk?: () => void, options?: MessageDialogOptions): Partial<ICommonDialog>;
    /**
     ...
     */
    function warningDialog(message: string, options?: MessageDialogOptions): Partial<ICommonDialog>;
     ...
     */
    function iframeDialog(options: IFrameDialogOptions): Partial<ICommonDialog>;
    /**
     ...
     */
    function closePanel(element: (HTMLElement | ArrayLike<HTMLElement>), e?: Event): void;
    /**
