...
declare function inputGroupButtonAddon(props: {
    before?: boolean;
    text: string;
    icon?: IconClassName;
    buttonClass?: string;
...
declare function inputGroupTextAddon(props: {
    before?: boolean;
    text: string;
    icon?: IconClassName;
    cssClass?: string;
...
declare function formTextAddon(props: {
    text: string;
    before?: boolean;
    cssClass?: string;
    editorElement: HTMLElement;
