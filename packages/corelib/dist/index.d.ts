...
declare function PropertyGridCategoryTitle(props: {
    category: string;
    localTextPrefix: string;
}): HTMLElement;
declare function PropertyGridCategory(props: {
    category?: string;
    children?: any;
    collapsed?: boolean;
    localTextPrefix?: string;
