import { Column, EventEmitter, FormatterContext, FormatterResult, Grid, GridOptions, Group, GroupItemMetadataProvider, GroupTotals, IDataView, IEventData, IGroupTotals } from '@serenity-is/sleekgrid';
...
export interface RemoteViewOptions<TItem = any> {
	...
	getItemMetadata?: (item: TItem, row: number) => any;
