...
declare class TimeEditorBase<P extends TimeEditorOptions = TimeEditorOptions> extends EditorWidget<P> {
    static createDefaultElement(): HTMLElement;
...
declare class TimeSpanEditor<P extends TimeEditorOptions = TimeEditorOptions> extends TimeEditorBase<P> {
    protected get_value(): string;
    protected set_value(value: string): void;
    get value(): string;
    set value(value: string);
