...
declare function tryGetWidget<TWidget>(element: Element | string, type?: {
    new (...args: any[]): TWidget;
}): TWidget;
declare function getWidgetFrom<TWidget>(element: Element | string, type?: {
    new (...args: any[]): TWidget;
}): TWidget;
type IdPrefixType = {
    [key: string]: string;
