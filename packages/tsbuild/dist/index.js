...
import fs from "fs";
var defaultEntryPointGlobs = ["Modules/**/*Page.ts", "Modules/**/*Page.tsx", "Modules/**/ScriptInit.ts", "Modules/**/*.mts"];
var importAsGlobalsMapping = {
...
function safeGlobSync(globs, options = {}) {
...
var tsbuildGlobalBundleDefaults = {
  entryPoints: [
...
function importAsGlobalsPlugin(mapping) {
