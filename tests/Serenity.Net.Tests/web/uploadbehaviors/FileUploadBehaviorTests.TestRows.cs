...
public partial class FileUploadBehaviorTests
{
    public class TestRow : Row<TestRow.RowFields>
    {
        ...
        [ImageUploadEditor]
        public string StringFieldImageUploadEditor { get => fields.StringFieldImageUploadEditor[this]; set => fields.StringFieldImageUploadEditor[this] = value; }

        [ImageUploadEditor(DisableDefaultBehavior = true)]
        public string ImageUploadEditorDisableDefaultBehavior { get => fields.ImageUploadEditorDisableDefaultBehavior[this]; set => fields.ImageUploadEditorDisableDefaultBehavior[this] = value; }
    ...
    public class TestIIdRow : Row<TestIIdRow.RowFields>, IIdRow
    {
        ...
        [ImageUploadEditor]
        public int? IntegerFieldImageUploadEditor { get => fields.IntegerFieldImageUploadEditor[this]; set => fields.IntegerFieldImageUploadEditor[this] = value; }

        [Expression("(SELECT 'TEST')")]
        public string StringFieldExpression { get => fields.StringFieldExpression[this]; set => fields.StringFieldExpression[this] = value; }
        
        [Expression("(SELECT 123)")]
        public int? IntegerFieldExpression { get => fields.IntegerFieldExpression[this]; set => fields.IntegerFieldExpression[this] = value; }

        [ImageUploadEditor(FilenameFormat = "Test/|StringFieldExpression|")]
        public string ImageUploadEditorReplaceField { get => fields.ImageUploadEditorReplaceField[this]; set => fields.ImageUploadEditorReplaceField[this] = value; }

        [ImageUploadEditor(FilenameFormat = "Test/||")]
        public string ImageUploadEditorInvalidReplaceField { get => fields.ImageUploadEditorInvalidReplaceField[this]; set => fields.ImageUploadEditorInvalidReplaceField[this] = value; }
        
        [ImageUploadEditor(FilenameFormat = "Test/|ThisFieldDoesntExist|")]
        public string ImageUploadEditorReplaceFieldNoField { get => fields.ImageUploadEditorReplaceFieldNoField[this]; set => fields.ImageUploadEditorReplaceFieldNoField[this] = value; }

        [ImageUploadEditor(OriginalNameProperty = nameof(RowFields.Name))]
        public string ImageUploadEditorOriginalName { get => fields.ImageUploadEditorOriginalName[this]; set => fields.ImageUploadEditorOriginalName[this] = value; }

        [ImageUploadEditor(OriginalNameProperty = nameof(RowFields.Id))]
        public string ImageUploadEditorOriginalNameIntegerField { get => fields.ImageUploadEditorOriginalNameIntegerField[this]; set => fields.ImageUploadEditorOriginalNameIntegerField[this] = value; }

        [ImageUploadEditor(OriginalNameProperty = "ThisFieldDoesntExist")]
        public string ImageUploadEditorOriginalNameNoField { get => fields.ImageUploadEditorOriginalNameNoField[this]; set => fields.ImageUploadEditorOriginalNameNoField[this] = value; }

        [ImageUploadEditor(CopyToHistory = true)]
        public string ImageUploadEditorCopyToHistory { get => fields.ImageUploadEditorCopyToHistory[this]; set => fields.ImageUploadEditorCopyToHistory[this] = value; }

        public string Empty { get => fields.Empty[this]; set => fields.Empty[this] = value; }
