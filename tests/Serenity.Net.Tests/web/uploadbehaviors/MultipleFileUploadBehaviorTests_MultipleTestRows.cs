...
public partial class MultipleFileUploadBehaviorTests
{
    ...
    public class MultipleTestIIdRow : Row<MultipleTestIIdRow.RowFields>, IIdRow
    {
        ...
        public string ImageUploadEditorCorrectEditorType { get => fields.ImageUploadEditorCorrectEditorType[this]; set => fields.ImageUploadEditorCorrectEditorType[this] = value; }
