...
public class ComplexRow : Row<ComplexRow.RowFields>
{
    ...
    public string Overriden { get => fields.Overriden[this]; set => fields.Overriden[this] = value; }
    ...
    public string ConcatExpression { get => fields.ConcatExpression[this]; set => fields.ConcatExpression[this] = value; }

    [DisplayName("Basic Expression"), Expression("SomeField")]
    public string BasicExpression { get => fields.BasicExpression[this]; set => fields.BasicExpression[this] = value; }

    [DisplayName("Quoted Expression"), Expression("[SomeField]")]
    public string QuotedExpression { get => fields.QuotedExpression[this]; set => fields.QuotedExpression[this] = value; }

    [DisplayName("Alias Dot Quoted Expression"), Expression("t0.[ThatField]")]
    public string AliasDotQuotedExpression { get => fields.AliasDotQuotedExpression[this]; set => fields.AliasDotQuotedExpression[this] = value; }
