...
public class InsertPermissionAttributeTests
{
    ...
    {
        var attribute = new InsertPermissionAttribute(IO.DeleteType.Delete);
    ...
    {
        var attribute = new InsertPermissionAttribute(IO.DeleteType.Delete, IO.DeleteType.TryDelete);
    ...
    {
        var attribute = new InsertPermissionAttribute(IO.DeleteType.Delete, IO.DeleteType.TryDelete, IO.DeleteType.TryDeleteOrMark);
