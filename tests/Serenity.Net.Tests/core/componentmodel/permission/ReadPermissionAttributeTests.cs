...
public class ReadPermissionAttributeTests
{
    ...
    {
        var attribute = new ReadPermissionAttribute(IO.DeleteType.Delete);
    ...
    {
        var attribute = new ReadPermissionAttribute(IO.DeleteType.Delete, IO.DeleteType.TryDelete);
    ...
    {
        var attribute = new ReadPermissionAttribute(IO.DeleteType.Delete, IO.DeleteType.TryDelete, IO.DeleteType.TryDeleteOrMark);
