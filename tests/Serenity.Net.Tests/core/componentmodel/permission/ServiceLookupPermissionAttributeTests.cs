...
public class ServiceLookupPermissionAttributeTests
{
    ...
    {
        var attribute = new ServiceLookupPermissionAttribute(IO.DeleteType.Delete);
    ...
    {
        var attribute = new ServiceLookupPermissionAttribute(IO.DeleteType.Delete, IO.DeleteType.TryDelete);
    ...
    {
        var attribute = new ServiceLookupPermissionAttribute(IO.DeleteType.Delete, IO.DeleteType.TryDelete, IO.DeleteType.TryDeleteOrMark);
