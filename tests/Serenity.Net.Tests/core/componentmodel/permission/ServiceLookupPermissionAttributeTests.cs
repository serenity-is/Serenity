...
public class ServiceLookupPermissionAttributeTests
{
    [Fact]
    public void Constructor_With_String()
    {
        var attribute = new ServiceLookupPermissionAttribute("a");
    ...
    {
        var attribute = new ServiceLookupPermissionAttribute("a", "a");
    ...
    {
        var attribute = new ServiceLookupPermissionAttribute("a", "b", "c");
    ...
    {
        var attribute = new ServiceLookupPermissionAttribute(Serenity.IO.DeleteType.Delete);
    ...
    {
        var attribute = new ServiceLookupPermissionAttribute(Serenity.IO.DeleteType.Delete, Serenity.IO.DeleteType.TryDelete);
    ...
    {
        var attribute = new ServiceLookupPermissionAttribute(Serenity.IO.DeleteType.Delete, Serenity.IO.DeleteType.TryDelete, Serenity.IO.DeleteType.TryDeleteOrMark);
    ...
    {
        var attribute = new ServiceLookupPermissionAttribute(1);
    ...
    {
        var attribute = new ServiceLookupPermissionAttribute(1, 2);
    ...
    {
        var attribute = new ServiceLookupPermissionAttribute(1, 2, 3);
    ...
    {
        var attribute = new ServiceLookupPermissionAttribute(null, null);
    ...
    {
        var attribute = new ServiceLookupPermissionAttribute(null, null, null);
        Assert.Equal("::", attribute.Permission);
    }
}
