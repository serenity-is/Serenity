...
public class RegisterPermissionKeyAttributeTests
{
    ...
    {
        var attribute = new RegisterPermissionKeyAttribute(IO.DeleteType.Delete);
    ...
    {
        var attribute = new RegisterPermissionKeyAttribute(IO.DeleteType.Delete, IO.DeleteType.TryDelete);
    ...
    {
        var attribute = new RegisterPermissionKeyAttribute(IO.DeleteType.Delete, IO.DeleteType.TryDelete, IO.DeleteType.TryDeleteOrMark);
