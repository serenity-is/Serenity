...
public class UpdatePermissionAttributeTests
{
    ...
    {
        var attribute = new UpdatePermissionAttribute(IO.DeleteType.Delete);
    ...
    {
        var attribute = new UpdatePermissionAttribute(IO.DeleteType.Delete, IO.DeleteType.TryDelete);
    ...
    {
        var attribute = new UpdatePermissionAttribute(IO.DeleteType.Delete, IO.DeleteType.TryDelete, IO.DeleteType.TryDeleteOrMark);
