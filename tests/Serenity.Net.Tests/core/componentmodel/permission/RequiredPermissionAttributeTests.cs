...
public class RequiredPermissionAttributeTests
{
    [Fact]
    public void Constructor_With_String()
    {
        var attribute = new RequiredPermissionAttribute("a");
    ...
    {
        var attribute = new RequiredPermissionAttribute("a", "a");
    ...
    {
        var attribute = new RequiredPermissionAttribute("a", "b", "c");
    ...
    {
        var attribute = new RequiredPermissionAttribute(Serenity.IO.DeleteType.Delete);
    ...
    {
        var attribute = new RequiredPermissionAttribute(Serenity.IO.DeleteType.Delete, Serenity.IO.DeleteType.TryDelete);
    ...
    {
        var attribute = new RequiredPermissionAttribute(Serenity.IO.DeleteType.Delete, Serenity.IO.DeleteType.TryDelete, Serenity.IO.DeleteType.TryDeleteOrMark);
    ...
    {
        var attribute = new RequiredPermissionAttribute(1);
        Assert.Equal("1", attribute.Permission);
    }
    [Fact]
    public void Constructor_With_Int_Int()
    {
        var attribute = new RequiredPermissionAttribute(1, 2);
    ...
    {
        var attribute = new RequiredPermissionAttribute(1, 2, 3);
    ...
    {
        var attribute = new RequiredPermissionAttribute(null, null);
    ...
    {
        var attribute = new RequiredPermissionAttribute(null, null, null);
        Assert.Equal("::", attribute.Permission);
    }
}
