...
public class RequiredPermissionAttributeTests
{
    ...
    {
        var attribute = new RequiredPermissionAttribute(IO.DeleteType.Delete);
    ...
    {
        var attribute = new RequiredPermissionAttribute(IO.DeleteType.Delete, IO.DeleteType.TryDelete);
    ...
    {
        var attribute = new RequiredPermissionAttribute(IO.DeleteType.Delete, IO.DeleteType.TryDelete, IO.DeleteType.TryDeleteOrMark);
