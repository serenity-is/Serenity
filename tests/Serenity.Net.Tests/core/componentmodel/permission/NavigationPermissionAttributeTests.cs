...
public class NavigationPermissionAttributeTests
{

    [Fact]
    public void Constructor_With_String()
    {
        var attribute = new NavigationPermissionAttribute("a");
    ...
    {
        var attribute = new NavigationPermissionAttribute("a", "a");
    ...
    {
        var attribute = new NavigationPermissionAttribute("a", "b", "c");
    ...
    {
        var attribute = new NavigationPermissionAttribute(1);
    ...
    {
        var attribute = new NavigationPermissionAttribute(1, 2);
    ...
    {
        var attribute = new NavigationPermissionAttribute(1, 2, 3);
    ...
    {
        var attribute = new NavigationPermissionAttribute(null, null);
    ...
    {
        var attribute = new NavigationPermissionAttribute(null, null, null);
        Assert.Equal("::", attribute.Permission);
    }
}