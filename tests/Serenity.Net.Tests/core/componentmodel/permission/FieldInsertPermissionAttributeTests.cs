...
public class FieldInsertPermissionAttributeTests
{
    ...
    {
        var attribute = new FieldInsertPermissionAttribute(IO.DeleteType.Delete);
        Assert.Equal("Delete", attribute.Permission);
    }
    [Fact]
    public void Constructor_With_Enum_Enum()
    {
        var attribute = new FieldInsertPermissionAttribute(IO.DeleteType.Delete, IO.DeleteType.TryDelete);
    ...
    {
        var attribute = new FieldInsertPermissionAttribute(IO.DeleteType.Delete, IO.DeleteType.TryDelete, IO.DeleteType.TryDeleteOrMark);
