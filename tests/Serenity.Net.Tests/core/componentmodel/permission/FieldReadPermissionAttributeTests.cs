...
public class FieldReadPermissionAttributeTests
{
    ...
    {
        var attribute = new FieldReadPermissionAttribute(IO.DeleteType.Delete);
    ...
    {
        var attribute = new FieldReadPermissionAttribute(IO.DeleteType.Delete, IO.DeleteType.TryDelete);
    ...
    {
        var attribute = new FieldReadPermissionAttribute(IO.DeleteType.Delete, IO.DeleteType.TryDelete, IO.DeleteType.TryDeleteOrMark);
