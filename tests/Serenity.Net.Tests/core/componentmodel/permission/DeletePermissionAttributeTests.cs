...
public class DeletePermissionAttributeTests
{
    ...
    {
        var attribute = new DeletePermissionAttribute(IO.DeleteType.Delete);
    ...
    {
        var attribute = new DeletePermissionAttribute(IO.DeleteType.Delete, IO.DeleteType.TryDelete);
    ...
    {
        var attribute = new DeletePermissionAttribute(IO.DeleteType.Delete, IO.DeleteType.TryDelete, IO.DeleteType.TryDeleteOrMark);
