...
public partial class CriteriaFieldExpressionReplacerTests
{
    ...
    private class TestRow : Row<TestRow.RowFields>, IIdRow
    {
        ...
        [LookupInclude]
        public string LookupIncludeField { get => fields.LookupIncludeField[this]; set => fields.LookupIncludeField[this] = value; }

        public string NormalField { get => fields.NormalField[this]; set => fields.NormalField[this] = value; }
        
        [ReadPermission(ExtraReadPermission)]
        public string ExtraReadPermissionField { get => fields.ExtraReadPermissionField[this]; set => fields.ExtraReadPermissionField[this] = value; }
        
        [ReadPermission(ExtraReadPermission), LookupInclude]
        public string ExtraReadPermissionWithLookupIncludeField { get => fields.ExtraReadPermissionWithLookupIncludeField[this]; set => fields.ExtraReadPermissionWithLookupIncludeField[this] = value; }
        
        [SetFieldFlags(FieldFlags.DenyFiltering)]
        public string DenyFilteringField { get => fields.DenyFilteringField[this]; set => fields.DenyFilteringField[this] = value; }

        [NotMapped]
        public string NotMappedField { get => fields.NotMappedField[this]; set => fields.NotMappedField[this] = value; }
